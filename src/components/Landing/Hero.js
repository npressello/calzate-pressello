...
const Hero = () => {
  ...
  return(
    <div className='relative mx-auto font-roboto'>
      ...
      <span className='absolute text-2xl bottom-10 left-10 md:text-3xl md:bottom-10 md:left-auto md:right-10 lg:text-4xl lg:right-20 lg:bottom-20 text-neutral-200 font-bold z-10'>PERO SIEMPRE HACIA ADELANTE</span>
