        ...
        <tbody className="font-roboto">
          {products.map(product =>
            <tr className="border-b">
              ...
              <td className="px-2 py-4">{product.item.price}</td>
              <td className="px-2 py-4">{product.quantity}</td>
              <td className="px-2 py-4">{product.item.price * product.quantity}</td>
              <td className="px-2 py-4"><RemoveFromCart /></td>
            </tr>
          )}
          <tr className="border-b">
            ...
            <td className="px-4 py-4">12999</td>
            <td className="px-4 py-4">Finalizar Compra</td>
          </tr>
        </tbody>
      </table>
    </div>
