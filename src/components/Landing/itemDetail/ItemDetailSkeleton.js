const ItemDetail = () => {
  ...
  return(
    <div className="container mx-auto my-10 flex flex-col md:flex-row">
      ...
      <div className='md:ml-2 md:mr-auto'>
        <h1 className='bg-neutral-400 w-56 h-10'></h1>
        <p className='bg-neutral-400 w-64 h-4 my-3'></p>
        <p className='bg-neutral-400 w-44 h-2 my-1'></p>
        <p className='bg-neutral-400 w-44 h-2 my-1'></p>
        <h2 className='bg-neutral-400 w-36 h-8 my-5'></h2>
