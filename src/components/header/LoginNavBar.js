        ...
        <div className='relative hidden ml-auto md:flex'>
          ...
          <form id='login-popup-div' className='hidden absolute rounded border border-calzate-700 p-2 top-16 right-0 bg-white flex flex-col shadow-md z-10'>
            ...
            <div className='flex my-2'>
              <button id='btn-login-large' type='submit' className="p-1 mx-auto rounded hover:bg-calzate-400 border-2 border-calzate-400 text-calzate-100 hover:text-calzate-800 hover:font-semibold">Ingresar</button>
              <button id='btn-signup-large' type='submit' className="p-1 mx-auto rounded bg-calzate-400 hover:bg-calzate-700 border border-calzate-400 hover:border-calzate-700 text-calzate-800 hover:text-calzate-100 font-semibold">Registrarse</button>
            </div>            
          </form>
        </div>
    </>
